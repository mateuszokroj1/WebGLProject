...
export default class WebGlShaderProgram implements IInitializable<HTMLCanvasElement> {
    ...
    async initialize(canvas: HTMLCanvasElement): Promise<void> {
        ...
        context.vertexAttribPointer(this.attribute_locations.position, 3, context.FLOAT, false, 2 * 3 * 4, 0);
        context.vertexAttribPointer(this.attribute_locations.normal, 3, context.FLOAT, true, 3 * 4 * 2, 3 * 4);
